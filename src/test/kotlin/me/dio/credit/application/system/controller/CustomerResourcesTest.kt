...
class CustomerResourcesTest {
    ...
    fun `should create a customer and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Gustavo"))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("guga.h.costaesilva@gmail.com"))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua dos Espertos"))
    ...
    fun `should update a customer and return 200 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("GugaUpdate"))
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Rua dos Espertos Updated"))
            //.andExpect(MockMvcResultMatchers.jsonPath("$.id").value(1))
            .andDo(MockMvcResultHandlers.print())
    }
    ...
    private fun builderCustomerDto(
        ...
        email: String = "guga.h.costaesilva@gmail.com",
        income: BigDecimal = BigDecimal.valueOf(2000.0),
        password: String = "12345",
        zipCode: String = "000000",
        street: String = "Rua dos Espertos"
    ...
    private fun builderCustomerUpdateDto(
        firstName: String = "GugaUpdate",
        lastName: String = "SilvaUpdate",
        income: BigDecimal = BigDecimal.valueOf(5000.0),
        zipCode: String = "45656",
        street: String = "Rua dos Espertos Updated"
